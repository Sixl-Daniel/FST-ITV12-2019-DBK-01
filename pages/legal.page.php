...
<section class="section section--legal">
    <div class="row">
        <div class="col s12 m10 push-m1 l6 push-l3 center-align">
            <h3>Impressum</h3>
    ...
    <div class="row">
        <div class="col s12 m10 push-m1 l6 push-l3">
            <h3 class="center-align">Daten&shy;schutz</h3>
                ...
                <h4>1) Datenschutz in der Übersicht</h4>
                ...
                <p>Der Webspace-Provider (webgo GmbH, Wandsbeker Zollstr. 95, 22041 Hamburg) erhebt und speichert, aus technischen Gründen, automatisch Informationen in so genannten Server-Log-Dateien, die Ihr Browser automatisch an uns übermittelt. Dies sind:</p>
                <ul class="collection">
                ...
                <p>Mit dem Webspace-Provider wurde eine Vereinbarung zur Auftragsdatenverarbeitung, gemäß Art. 28 DSGVO, unterzeichnet.</p>
                <h4>4) Soziale Medien</h4>
                <p>Auf dieser Website werden aktuell keine Plugins von sozialen Netzwerken (Facebook, Twitter, o.ä.) verwendet. Es besteht also keine Gefahr, dass durch Ihren Besuch auf unserer Webseite Anbieter sozialer Netzwerke automatisiert Daten erheben. Es werden lediglich reguläre Verlinkungen angeboten, die auf den jeweiligen Anbieter verweisen.</p>
                <h4>5) Sonstige Plugins und Tools</h4>
